...
class User: NSObject {
    ...
    init(dict : [String:Any]) {
        ...
        if let kabocha_room_number = dict["kabocha_room_number"] as? String {
            m_kabocha_room_number = kabocha_room_number
        }
        
        if let kabocha_building_name = dict["kabocha_building_name"] as? String {
            m_kabocha_building_name = kabocha_building_name
        }
        
        if let kabocha_building_id = dict["kabocha_building_id"] as? String {
    ...
    required convenience init(coder aDecoder: NSCoder) {
        ...
        self.m_kabocha_room_number = aDecoder.decodeObject(forKey: "kabocha_room_number") as! String
        self.m_kabocha_building_name = aDecoder.decodeObject(forKey: "kabocha_building_name") as! String
        self.m_kabocha_building_id = aDecoder.decodeObject(forKey: "kabocha_building_id") as! String
    ...
    func encode(with aCoder: NSCoder) {
        ...
        aCoder.encode(m_kabocha_room_number, forKey: "kabocha_room_number")
        aCoder.encode(m_kabocha_building_name, forKey: "kabocha_building_name")
        aCoder.encode(m_kabocha_building_id, forKey: "kabocha_building_id")
